...
var OSC_RESERVED_USER_NAMES = ["explore", "repositories", "popular", "enterprises", "gists", "dashboard", "languages", "search", "links", "invite", "profile", "organizations", "notifications", "login", "signup", "oauth"];
var OSC_RESERVED_REPO_NAMES = ["admin", "dashboard", "groups", "help", "profile", "projects", "search", "codes", "fork_project", "fork_code"];
var OSC_404_SEL = '#parallax_wrapper';
var OSC_PJAX_CONTAINER_SEL = '#git-project-content';
...
var Oschina = function (_PjaxAdapter) {
  ...
  function Oschina(store) {
    _classCallCheck(this, Oschina);

    return _possibleConstructorReturn(this, (Oschina.__proto__ || Object.getPrototypeOf(Oschina)).call(this, store));
  }
  ...
  _createClass(Oschina, [{
    ...
    value: function init($sidebar) {
      ...
      _get(Oschina.prototype.__proto__ || Object.getPrototypeOf(Oschina.prototype), "init", this).call(this, $sidebar, { 'pjaxContainer': pjaxContainer });
    ...
    value: function selectFile(path) {
      ...
      _get(Oschina.prototype.__proto__ || Object.getPrototypeOf(Oschina.prototype), "selectFile", this).call(this, path, { '$pjaxContainer': $pjaxContainer, fragment: OSC_PJAX_CONTAINER_SEL });
    }
...
$(document).ready(function () {
  ...
  function createAdapter() {
    ...
    var oschinaUrls = ['http://git.oschina.net', 'https://git.oschina.net', 'http://gitee.com', 'https://gitee.com'];
